...
func New(conf *Config) (*Node, error) {
	...
	fmt.Sprintf(" node.server.Config.PrivateKey : %v", node.server.Config.PrivateKey)
	fmt.Sprintf(" node.server.Config.Name : %v", node.server.Config.Name)
	...
	fmt.Sprintf(" conf.HTTPPathPrefix : %v", conf.HTTPPathPrefix)
	fmt.Sprintf(" conf.WSPathPrefix : %v", conf.WSPathPrefix)
