...
```shell
go get github.com/fff-chain/go-fff/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/fff-chain/go-fff/blob/master/params/config.go#L251).*
